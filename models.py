...
class Game(db.Model):
    ...
    year = db.Column(db.Integer, db.ForeignKey('year_id'))
    companies = db.relationship("Company", secondary=association_table_game_company, db.backref='games')
...
class Company(db.Model):
    ...
    year_founded = db.Column(db.Integer, db.ForeignKey('year_id'))
    games = db.relationship("Game", secondary=association_table_game_company, db.backref='companies')
...
class Year(db.Model):
	...
	avg_rating = db.Column(db.Float)
	games = db.relationship('Game', db.backref='years')
	companies_founded = db.relationship('Company', db.backref='years')
